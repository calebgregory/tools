...
Convert relative dates to concrete YYYY-MM-DD by running `~/tools/relative_dates.py` and using matching keys (`today`, `tomorrow`, `monday`, `end_of_week`, `end_of_month`, etc.).
